...
<div x-show="showResults" x-cloak
    ...
    {{-- Loading indicator --}}
    <div x-show="loading && results.length === 0" x-cloak class="px-4 py-6 text-center text-sm text-muted">
    ...
    {{-- No results --}}
    <div x-show="!loading && results.length === 0" x-cloak class="px-4 py-6 text-center text-sm text-muted" style="display: none;">
        {{ __('No products found.', 'woocommerce') }}
    </div>

    {{-- Results list --}}
    <ul x-show="results.length > 0" x-cloak class="divide-y divide-outline max-h-80 overflow-y-auto" role="listbox" style="display: none;">
    ...
    {{-- View all link --}}
    <div x-show="results.length > 0" x-cloak class="border-t border-outline" style="display: none;">
